    ...
    <div className="relative p-5 sm:p-6 bg-[#0b0e14]/90 backdrop-blur border border-slate-800 rounded-xl shadow-lg font-mono">
      ...
      <div className="space-y-2.5 text-xs text-slate-300">
        <div className="flex justify-between items-center border-b border-slate-800/80 pb-2">
          ...
          <span className="text-emerald-400 font-bold tracking-wide">OPEN_FOR_PROJECTS</span>
        </div>
        <div className="flex justify-between items-center border-b border-slate-800/80 pb-2">
          <span className="text-slate-400">LOC:</span>
          <span className="text-slate-200 font-medium">TASIKMALAYA (UTC+7)</span>
        </div>
        <div className="flex justify-between items-center pt-0.5">
          <span className="text-slate-400">TIME:</span>
          <span className="text-sky-400 font-bold tracking-widest">{currentTime || '17:00:00'}</span>
        </div>
      </div>
    </div>
  );
